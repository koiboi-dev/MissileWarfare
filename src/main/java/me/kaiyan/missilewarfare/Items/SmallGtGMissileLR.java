...
public class SmallGtGMissileLR extends SlimefunItem {
    public SmallGtGMissileLR(ItemGroup itemGroup, SlimefunItemStack item, RecipeType recipeType, ItemStack[] recipe) {

...
public class Translations {
    ...
    public static String getPage(String key) {
        ...
        String[] arr = getArray(key + ".content");
    ...
    public static String getMissileName(String type) {
        return ChatColor.translateAlternateColorCodes('&', "&e" + get(
                "missiles." + missileType + ".missiles." + type + ".name"));
    }

    public static String getMissileVariant(String type) {
        return ChatColor.translateAlternateColorCodes('&', "&a" + get(
                "missiles." + missileType + ".missiles." + type + ".variant"));
    }

    public static String getMissileLore(String type) {
        return ChatColor.translateAlternateColorCodes('&', "&7" + get(
                "missiles." + missileType + ".missiles." + type + ".lore"));
    }
